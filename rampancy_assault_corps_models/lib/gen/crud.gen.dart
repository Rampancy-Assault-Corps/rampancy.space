...
extension XFCrudBase$AccountLink on AccountLink {
  ...
  Future<void> setAtomic(AccountLink Function(AccountLink?) txn) => setSelfAtomicRaw<AccountLink>(txn);
  ...
  Future<void> modify({
    ...
    updateSelfRaw<AccountLink>({ 
      ...
      if(deltaDiscordLinkedAt != null) 'discordLinkedAt': FieldValue.increment(deltaDiscordLinkedAt),
      ...
      if(bungieRefreshCiphertext != null) 'bungieRefreshCiphertext': bungieRefreshCiphertext,
      if(deleteBungieRefreshCiphertext) 'bungieRefreshCiphertext': FieldValue.delete(),
      ...
      if(bungieRefreshExpiresAt != null) 'bungieRefreshExpiresAt': bungieRefreshExpiresAt,
      if(deltaBungieRefreshExpiresAt != null) 'bungieRefreshExpiresAt': FieldValue.increment(deltaBungieRefreshExpiresAt),
      if(deleteBungieRefreshExpiresAt) 'bungieRefreshExpiresAt': FieldValue.delete(),
      if(updatedAt != null) 'updatedAt': updatedAt,
      if(deltaUpdatedAt != null) 'updatedAt': FieldValue.increment(deltaUpdatedAt),
...
extension XFCrud$AccountLink$BungieMembership on AccountLink {
  ...
  Future<int> countBungieMemberships([CollectionReference Function(CollectionReference ref)? query]) => $count<BungieMembership>(query);
  
  /// Gets all [BungieMembership] inside [AccountLink] in the collection optionally filtered by [query]
  Future<List<BungieMembership>> getBungieMemberships([CollectionReference Function(CollectionReference ref)? query]) => getAll<BungieMembership>(query);
  ...
  Future<ModelPage<BungieMembership>?> paginateBungieMemberships({int pageSize = 50, bool reversed = false, CollectionReference Function(CollectionReference ref)? query}) => paginate<BungieMembership>(pageSize: pageSize, reversed: reversed, query: query);
  
  /// Opens a stream of all [BungieMembership] inside [AccountLink] in the collection optionally filtered by [query]
  Stream<List<BungieMembership>> streamBungieMemberships([CollectionReference Function(CollectionReference ref)? query]) => streamAll<BungieMembership>(query);
  
  /// Sets the [BungieMembership] inside [AccountLink] document with [id] to a new value
  Future<void> setBungieMembership(String id, BungieMembership value) => $set<BungieMembership>(id, value);
  
  /// Gets the [BungieMembership] inside [AccountLink] document with [id]
  Future<BungieMembership?> getBungieMembership(String id) => $get<BungieMembership>(id);
  
  /// Gets the [BungieMembership] inside [AccountLink] document with [id] and caches it for the next time
  Future<BungieMembership?> getBungieMembershipCached(String id) => getCached<BungieMembership>(id);
  
  /// Updates properties of the [BungieMembership] inside [AccountLink] document with [id] with {"fieldName": VALUE, ...}
  Future<void> updateBungieMembership(String id, Map<String, dynamic> updates) => $update<BungieMembership>(id, updates);
  
  /// Opens a stream of the [BungieMembership] inside [AccountLink] document with [id]
  Stream<BungieMembership?> streamBungieMembership(String id) => $stream<BungieMembership>(id);
  
  /// Deletes the [BungieMembership] inside [AccountLink] document with [id]
  Future<void> deleteBungieMembership(String id) => $delete<BungieMembership>(id);
  
  /// Adds a new [BungieMembership] inside [AccountLink] document with a new id and returns the created model with the id set
  Future<BungieMembership> addBungieMembership(BungieMembership value, {bool useULID = false}) => $add<BungieMembership>(value, useULID: useULID);
  
  /// Sets the [BungieMembership] inside [AccountLink] document with [id] atomically by getting first then setting.
  Future<void> setBungieMembershipAtomic(String id, BungieMembership Function(BungieMembership?) txn) => $setAtomic<BungieMembership>(id, txn);
  
  /// Ensures that the [BungieMembership] inside [AccountLink] document with [id] exists, if not it will be created with [or]
  Future<void> ensureBungieMembershipExists(String id, BungieMembership or) => $ensureExists<BungieMembership>(id, or);
  
  /// Gets a model instance of [BungieMembership] inside [AccountLink] bound with [id] that can be used to access child models
  /// without network io.
  BungieMembership bungieMembershipModel(String id) => $model<BungieMembership>(id);
  ...
  Future<void> modifyBungieMembership({
    ...
    $update<BungieMembership>(id, { 
      ...
      if(deltaMembershipType != null) 'membershipType': FieldValue.increment(deltaMembershipType),
      ...
      if(deltaCrossSaveOverride != null) 'crossSaveOverride': FieldValue.increment(deltaCrossSaveOverride),
...
extension XFCrudBase$BungieMembership on BungieMembership {
  ...
  Future<void> update(Map<String, dynamic> u) => updateSelfRaw<BungieMembership>(u);
  ...
  Future<void> setAtomic(BungieMembership Function(BungieMembership?) txn) => setSelfAtomicRaw<BungieMembership>(txn);
...
extension XFCrudRoot$AccountLink on RootFireCrud {
  ...
  Future<int> countAccountLinks([CollectionReference Function(CollectionReference ref)? query]) => $count<AccountLink>(query);
  
  /// Gets all [AccountLink] in the collection optionally filtered by [query]
  Future<List<AccountLink>> getAccountLinks([CollectionReference Function(CollectionReference ref)? query]) => getAll<AccountLink>(query);
  ...
  Future<ModelPage<AccountLink>?> paginateAccountLinks({int pageSize = 50, bool reversed = false, CollectionReference Function(CollectionReference ref)? query}) => paginate<AccountLink>(pageSize: pageSize, reversed: reversed, query: query);
  
  /// Deletes all [AccountLink] in the collection optionally filtered by [query]
  Future<void> deleteAllAccountLinks([CollectionReference Function(CollectionReference ref)? query]) => deleteAll<AccountLink>(query);
  
  /// Opens a stream of all [AccountLink] in the collection optionally filtered by [query]
  Stream<List<AccountLink>> streamAccountLinks([CollectionReference Function(CollectionReference ref)? query]) => streamAll<AccountLink>(query);
  
  /// Sets the [AccountLink] document with [id] to a new value
  Future<void> setAccountLink(String id, AccountLink value) => $set<AccountLink>(id, value);
  ...
  Future<AccountLink?> getAccountLinkCached(String id) => getCached<AccountLink>(id);
  
  /// Updates properties of the [AccountLink] document with [id] with {"fieldName": VALUE, ...}
  Future<void> updateAccountLink(String id, Map<String, dynamic> updates) => $update<AccountLink>(id, updates);
  ...
  Future<AccountLink> addAccountLink(AccountLink value, {bool useULID = false}) => $add<AccountLink>(value, useULID: useULID);
  
  /// Sets the [AccountLink] document with [id] atomically by getting first then setting.
  Future<void> setAccountLinkAtomic(String id, AccountLink Function(AccountLink?) txn) => $setAtomic<AccountLink>(id, txn);
  
  /// Ensures that the [AccountLink] document with [id] exists, if not it will be created with [or]
  Future<void> ensureAccountLinkExists(String id, AccountLink or) => $ensureExists<AccountLink>(id, or);

...
const _2 _S=['name','email','profileHash','Missing required User."name" in map ','Missing required User."email" in map ','themeMode','user','Missing required ServerCommand."user" in map ','_subclass_ServerResponse','ResponseOK','ResponseError','Missing required ServerResponse."user" in map ','Missing required ResponseOK."user" in map ','message','Missing required ResponseError."user" in map ','Missing required ResponseError."message" in map ','discordId','discordUsername','discordGlobalName','discordAvatarHash','discordLinkedAt','bungieConnected','bungieLinkedAt','bungieRefreshCiphertext','bungieRefreshNonce','bungieRefreshExpiresAt','updatedAt','Missing required AccountLink."discordId" in map ','Missing required AccountLink."discordUsername" in map ','Missing required AccountLink."discordLinkedAt" in map ','Missing required AccountLink."updatedAt" in map ','membershipId','membershipType','displayName','iconPath','crossSaveOverride','isPrimary','Missing required BungieMembership."membershipId" in map ','Missing required BungieMembership."membershipType" in map ','Missing required BungieMembership."updatedAt" in map ','signature','session','time','Missing required RampancyAssaultCorpsServerSignature."signature" in map ','Missing required RampancyAssaultCorpsServerSignature."session" in map ','Missing required RampancyAssaultCorpsServerSignature."time" in map ','rampancy_assault_corps_models'];const _j _V=[ThemeMode.system,false];const _g _T=true;const _g _F=false;_5 _ = ((){if(!_i.$i(_S[46])){_i.$r(_S[46],_i(isArtifact: $isArtifact,artifactMirror:{},constructArtifact:$constructArtifact,artifactToMap:$artifactToMap,artifactFromMap:$artifactFromMap));}
return 0;})();
...
extension $AccountLink on _c{
  ...
  _3 toXml({bool pretty=_F})=>_0.z(pretty,toMap);
  _3 toProperties()=>_0.h(toMap);
  _1 toMap(){_;return <_3, _4>{_S[16]:_0.ea(discordId),_S[17]:_0.ea(discordUsername),_S[18]:_0.ea(discordGlobalName),_S[19]:_0.ea(discordAvatarHash),_S[20]:_0.ea(discordLinkedAt),_S[21]:_0.ea(bungieConnected),_S[22]:_0.ea(bungieLinkedAt),_S[23]:_0.ea(bungieRefreshCiphertext),_S[24]:_0.ea(bungieRefreshNonce),_S[25]:_0.ea(bungieRefreshExpiresAt),_S[26]:_0.ea(updatedAt),}.$nn;}
  ...
  static _c fromMap(_1 r){_;_1 m=r.$nn;return _c(discordId: m.$c(_S[16])? _0.da(m[_S[16]], _3) as _3:(throw _f('${_S[27]}$m.')),discordUsername: m.$c(_S[17])? _0.da(m[_S[17]], _3) as _3:(throw _f('${_S[28]}$m.')),discordGlobalName: m.$c(_S[18]) ?  _0.da(m[_S[18]], _3) as _3? : null,discordAvatarHash: m.$c(_S[19]) ?  _0.da(m[_S[19]], _3) as _3? : null,discordLinkedAt: m.$c(_S[20])? _0.da(m[_S[20]], _5) as _5:(throw _f('${_S[29]}$m.')),bungieConnected: m.$c(_S[21]) ?  _0.da(m[_S[21]], _g) as _g : _V[1],bungieLinkedAt: m.$c(_S[22]) ?  _0.da(m[_S[22]], _5) as _5? : null,bungieRefreshCiphertext: m.$c(_S[23]) ?  _0.da(m[_S[23]], _3) as _3? : null,bungieRefreshNonce: m.$c(_S[24]) ?  _0.da(m[_S[24]], _3) as _3? : null,bungieRefreshExpiresAt: m.$c(_S[25]) ?  _0.da(m[_S[25]], _5) as _5? : null,updatedAt: m.$c(_S[26])? _0.da(m[_S[26]], _5) as _5:(throw _f('${_S[30]}$m.')),);}
  _c copyWith({_3? discordId,_3? discordUsername,_3? discordGlobalName,_g deleteDiscordGlobalName=_F,_3? discordAvatarHash,_g deleteDiscordAvatarHash=_F,_5? discordLinkedAt,_5? deltaDiscordLinkedAt,_g? bungieConnected,_g resetBungieConnected=_F,_5? bungieLinkedAt,_g deleteBungieLinkedAt=_F,_5? deltaBungieLinkedAt,_3? bungieRefreshCiphertext,_g deleteBungieRefreshCiphertext=_F,_3? bungieRefreshNonce,_g deleteBungieRefreshNonce=_F,_5? bungieRefreshExpiresAt,_g deleteBungieRefreshExpiresAt=_F,_5? deltaBungieRefreshExpiresAt,_5? updatedAt,_5? deltaUpdatedAt,})=>_c(discordId: discordId??_H.discordId,discordUsername: discordUsername??_H.discordUsername,discordGlobalName: deleteDiscordGlobalName?null:(discordGlobalName??_H.discordGlobalName),discordAvatarHash: deleteDiscordAvatarHash?null:(discordAvatarHash??_H.discordAvatarHash),discordLinkedAt: deltaDiscordLinkedAt!=null?(discordLinkedAt??_H.discordLinkedAt)+deltaDiscordLinkedAt:discordLinkedAt??_H.discordLinkedAt,bungieConnected: resetBungieConnected?_V[1]:(bungieConnected??_H.bungieConnected),bungieLinkedAt: deltaBungieLinkedAt!=null?(bungieLinkedAt??_H.bungieLinkedAt??0)+deltaBungieLinkedAt:deleteBungieLinkedAt?null:(bungieLinkedAt??_H.bungieLinkedAt),bungieRefreshCiphertext: deleteBungieRefreshCiphertext?null:(bungieRefreshCiphertext??_H.bungieRefreshCiphertext),bungieRefreshNonce: deleteBungieRefreshNonce?null:(bungieRefreshNonce??_H.bungieRefreshNonce),bungieRefreshExpiresAt: deltaBungieRefreshExpiresAt!=null?(bungieRefreshExpiresAt??_H.bungieRefreshExpiresAt??0)+deltaBungieRefreshExpiresAt:deleteBungieRefreshExpiresAt?null:(bungieRefreshExpiresAt??_H.bungieRefreshExpiresAt),updatedAt: deltaUpdatedAt!=null?(updatedAt??_H.updatedAt)+deltaUpdatedAt:updatedAt??_H.updatedAt,);
  static _c get newInstance=>_c(discordId: '',discordUsername: '',discordLinkedAt: 0,updatedAt: 0,);
}
extension $BungieMembership on _d{
  ...
  _3 toXml({bool pretty=_F})=>_0.z(pretty,toMap);
  _3 toProperties()=>_0.h(toMap);
  _1 toMap(){_;return <_3, _4>{_S[31]:_0.ea(membershipId),_S[32]:_0.ea(membershipType),_S[33]:_0.ea(displayName),_S[34]:_0.ea(iconPath),_S[35]:_0.ea(crossSaveOverride),_S[36]:_0.ea(isPrimary),_S[26]:_0.ea(updatedAt),}.$nn;}
